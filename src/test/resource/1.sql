...
CREATE TABLE [dbo].[MaterialContains](
	...
	[rowMaterialId] [char](32) NOT NULL,
...
CREATE TABLE [dbo].[PcEntity](
	...
	[sourcePartitionAreaNum] [int] NULL,
...
CREATE TABLE [dbo].[PcLogTransfer](
	...
	[targetPartitionAreaNum] [int] NULL,
...
CREATE TABLE [dbo].[PcType](
	[id] [char](32) NOT NULL,
	[pcRootId] [char](32) NULL,
	[projectId] [char](32) NULL,
	[name] [nvarchar](50) NULL,
...
GO
ALTER TABLE [dbo].[MaterialContains]  WITH CHECK ADD  CONSTRAINT [FK_MaterialContains_Element] FOREIGN KEY([rowMaterialId])
REFERENCES [dbo].[Material] ([id])
GO
