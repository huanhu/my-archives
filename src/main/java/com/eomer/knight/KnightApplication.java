...
//com.eomer.knight.config;
public class KnightApplication {

    private static Logger logger = LoggerFactory.getLogger("SysLogger");
    private static Logger logger2 = LoggerFactory.getLogger("ApiLogger");
    ...
    */ 
    public static void main(String[] args) {
        logger.info("slf4j 启动 SysLogger info ");
        logger.warn("slf4j 启动 SysLogger warn ");
        logger.error("slf4j 启动 SysLogger error ");

        logger2.info("slf4j 启动 ApiLogger info ");
        logger2.warn("slf4j 启动 ApiLogger warn ");
        logger2.error("slf4j 启动 ApiLogger error ");
